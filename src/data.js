/**
 * @fileoverview Static data for podcasts, genres, and season details.
 * @module data
 */
...
export const podcasts = [
  ...
  },
  {
    ...
    description:
      "The Cold War, Prohibition, the Gold Rush, the Space Race. Every part of your life can be traced to our history, but how well do you really know the stories that made America? We'll take you to the events, the times and the people that shaped our nation.",
    seasons: 51,
    image:
  ...
  },
  {
    ...
    title: "Scamfluencers",
    description:
      "You never really know someone…especially online. In today's world, the power of influence can be the quickest path to money and fame, and it often ends in ruin. These are the stories of the world's most insidious Scamfluencers. And we are their prey.",
    seasons: 3,
    image:
  ...
  },
  {
    ...
    title: "Even the Rich",
    description:
      "Our lives can be crazy, but you can take a break from it all with Wondery's Even the Rich, where co-hosts Brooke Siffrinn and Aricia Skidmore-Williams pull back the curtain on some of the greatest family dynasties in history, from the Murdochs to the Royals to the Carters.",
    seasons: 33,
    image:
  ...
  },
  {
    ...
    description:
      "Humans are resilient. In our toughest moments, we will fight, we will struggle, and we will triumph...often against the odds. Host-adventurers Mike Corey and Cassie De Pecol share thrilling stories of survival from around the world.",
    seasons: 19,
    image:
  ...
  },
  {
    ...
    description:
      "This podcast might not actually kill you, but it covers so many things that can. Each episode tackles a different disease, from its history, to its biology, and finally, how scared you need to be. Ecologists and epidemiologists Erin Welsh and Erin Allmann Updyke make infectious diseases acceptable fodder for dinner party conversation.",
    seasons: 5,
    image:
  ...
  },
  {
    ...
    description:
      "In a country obsessed with gossip, the great and the good fear one thing more than any other - scandal. British scandals change the course of history. They bring down governments, overthrow the rich and cause the mighty to fall. Some are about sex, others about money.",
    seasons: 19,
    image:
  ...
  },
  {
    ...
    description:
      "Everywhere around us are echoes of the past. Those echoes define the boundaries of states and countries, how we pray and how we fight. From Wondery, host Patrick Wyman, PhD helps us understand our world and how it got to be the way it is.",
    seasons: 5,
    image:
...
export const genres = [
  {
    ...
    description:
      "Looking to improve yourself and reach your full potential? Our curated selection features experts sharing insights on goal setting, productivity, mindfulness and self-care.",
  ...
  },
  {
    ...
    description:
      "Looking for a collection of podcasts that will keep you on the edge of your seat? These shows feature in-depth reporting and analysis of some of the most important and intriguing stories of our time.",
  ...
  },
  {
    ...
    title: "History",
    description:
      "Experience the past like never before. Whether you're a history buff or just looking to learn something new, our selection covers ancient civilizations to modern times.",
  ...
  },
  {
    ...
    title: "Comedy",
    description:
      "Get ready to laugh with our collection of comedy podcasts! From stand-up comedy to improv, our podcasts feature a wide range of comedic styles and formats.",
    shows: ["6807"],
  },
  {
    id: 5,
    title: "Entertainment",
    description:
      "Entertainment lovers, get ready for a treat! Our collection keeps you entertained, informed and up-to-date with all the latest trends in the entertainment world.",
    shows: ["6807"],
  },
  {
    id: 6,
    title: "Business",
    description:
      "Keep your finger on the pulse of the entertainment industry with in-depth analysis and expert insight into the business side of the entertainment world.",
  ...
  },
  {
    ...
    title: "Fiction",
    description:
      "Get ready to be transported to new worlds with our collection of fiction-focused entertainment podcasts spanning science fiction, fantasy, horror and more.",
    shows: ["6631", "9664", "8188", "9702"],
  },
  {
    id: 8,
    title: "News",
    description:
      "Stay informed and on top of the latest events with in-depth coverage and analysis of the most important stories happening around the world.",
    shows: ["8291", "5718"],
  },
  {
    id: 9,
    ...
    description:
      "Bring fun and learning to your family's ears with entertaining and educational content for children of all ages.",
    shows: ["8188", "9687", "9702"],
  },
];
